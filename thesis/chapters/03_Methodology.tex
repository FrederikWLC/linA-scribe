...
All models with hyperparameters were tuned to their best \acs{Dice} scores on the validation set in a series of 100 trials each using Optuna, a hyperparameter optimization framework.
