...
Without the hyperparameters of \acs{Gaussian}, this method thus introduces three hyperparameters: $n_{fgd}$, $n_{bgd}$, and the erosion kernel size $d$ \parencite[p. 636-37,639]{DigitalImageProcessing}.
