...
This image encoder takes the form of a \acf{ViT}, that similarly to a \acf{CNN} \parencite{LeCun1998} processes an input image in order to extract its features \parencite{imageworth16x16words}. % NEW: LeCun1998 -- LeCun et al. (1998), Gradient-based learning applied to document recognition, Proc. IEEE 86(11)
