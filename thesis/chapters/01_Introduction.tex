...
Due to the potential violation of \acf{IPR}, it was furthermore of particular interest, whether the annotation process could begin from the raw source images themselves, without relying on the undigitized but already completed expert drawings.


\subsection{A problem of small data}
The small size of the Linear A corpus and the irregularities in quality of its documents is a huge problem for the application of deep learning, as models created therefrom typically require large amounts of good quality data to perform well.
