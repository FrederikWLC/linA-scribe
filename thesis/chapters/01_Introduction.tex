...
\note{THIS WHOLE SECTIONS NEEDS TO BE REWRITTEN, AS IT IS CURRENTLY JUST A VERY ROUGH DRAFT.}
...
The work of this thesis presents itself as a first proof-of-concept (and a mapping of the difficulties involved) in using \acs{SAM} and modern computer vision to accelerate the expansion of the SigLA database.
