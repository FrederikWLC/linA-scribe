...
For more informative and better quality data, there does exist an online repository of 3D scans of Aegean inscriptions\footnote{The term "Aegean inscription" refers to the ancient writings found in the Aegean sea of the Mediterranean, including the scripts Linear A, Linear B, and Cretan Hieroglyphics.}.
