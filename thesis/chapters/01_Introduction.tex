...
Most of these papers found that \acs{SAM} still tends to struggle with niche domains, despite its impressive zero-shot\footnote{The term \textit{zeroshot} refers to model performance on hitherto unseen data.} generalization.
...
However, it has fortunately also been shown that the performance of \acs{SAM} can significantly improve through effective prompt engineering alone \parencite{promptSAM}, requiring no deep learning at all.

\section{Problem statement}
As previously stated, the aim of this project was to investigate whether parts of the process of creating annotated drawings for SigLA can be automated.
...
To concretize the research, the problem statement was therefore decomposed into three research questions - each accompanied by their respective operationalization (see the following subsection for details).
