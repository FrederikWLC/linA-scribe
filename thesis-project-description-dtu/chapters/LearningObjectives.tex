...
\noindent
The selected \acf{ILO} of this Thesis (also to be found in the study programme specification at \cite{GELOs}) attached with statements of justified relevance can be found below, listed in decreasingorder of relevance to the project.
...
\begin{enumerate}
    ...
    \note{Existing models and methods outside of the curriculum are identified, studied, and critically assessed with respect to their performance and suitability for segmentation of Linear A inscriptions.}
    ...
    \note{Research-based computer vision methods will be applied to support the digitization workflow of SigLA, contributing to the digital accessibility of the Linear A corpus.}
