...
For a decomposition of the problem statement into three research questions, see the following section.

\section{Research questions}
\begin{enumerate}
\item How well does advanced state-of-the-art segmentation methods like \acs{SAM} perform compared to simple classical image processing methods?
\item How much can be automated (clicks/interventions needed)?
\item How much time can be saved (UI, compared to manual work)?
\end{enumerate}
advanced vs simple all the way through, quantitative evaluation

A common operationality of those three is the combination of the following three generic steps:
1. the pre-processing of original document images to make them suitable for \acs{SAM},
2. the incorporation of \acs{SAM} into a segmentation tool potentially with the possibility of optional user interaction whose exports can be integrated into SigLA's workflow, and
3. the quantitative evaluation of the tool's performance compared to baselines against metrics of segmentation quality.
...
pre-processing, segmentation, post-processing, and export (e.g. as Krita files).
