...
def load_paths(image_paths: list[Path], data_root: Path | str = DATA_ROOT, binarized=True):
	data_root = Path(data_root)
...
def get_support_data(seed: int = 42, data_root: Path | str = DATA_ROOT, binarized=True):
	data_root = Path(data_root)
...
def get_val_data(seed: int = 42, data_root: Path | str = DATA_ROOT, binarized=True):
	data_root = Path(data_root)
...
def get_test_data(seed: int = 42, data_root: Path | str = DATA_ROOT, binarized=True):
	data_root = Path(data_root)
...
def get_test_data_by_difficulty(seed: int = 42, data_root: Path | str = DATA_ROOT, binarized=True):
	data_root = Path(data_root)
	_, _, test_paths = get_support_val_test_paths(seed=seed, data_root=data_root)
