...
class MobileSAMv2(SAM, BilateralTunable):
    ...
    USE_BILATERAL_FILTER_HYPERPARAMS = False
    

    def __init__(self, use_bilateral_filter: bool = False, use_bilateral_filter_hyperparams=False, use_best_of_three: bool = False,
                 d_bilateral: int = 15, sigma_bilateral: int = 75):
        self.use_bilateral_filter = bool(use_bilateral_filter)
        self.use_bilateral_filter_hyperparams = bool(use_bilateral_filter_hyperparams)
    ...
    def hyperparameters(self) -> dict:
        if self.use_bilateral_filter_hyperparams:
            return super().hyperparameters
        return {}

    @classmethod
    def hyperparameter_ranges(cls, trial: Trial) -> dict:
        if cls.USE_BILATERAL_FILTER_HYPERPARAMS:
...
class MobileSAMv2AutoPoint(MobileSAMv2):
    """Mobile SAM with automatic point prompts."""
    USE_BILATERAL_FILTER_HYPERPARAMS = True
    

    def __init__(self, use_bilateral_filter=False,
                 use_bilateral_filter_hyperparams=True,
                 use_best_of_three=False,
        ...
        super().__init__(use_bilateral_filter=use_bilateral_filter,
                         use_bilateral_filter_hyperparams=use_bilateral_filter_hyperparams,
                         use_best_of_three=use_best_of_three,
                         d_bilateral=d_bilateral,
                         sigma_bilateral=sigma_bilateral)
...
class MobileSAMv2BilateralFilter(MobileSAMv2):
    ...
    def __init__(self, d_bilateral=15, sigma_bilateral=75):
        super().__init__(use_bilateral_filter=True,
                         use_bilateral_filter_hyperparams=True,
                         use_best_of_three=False,
...
class MobileSAMv2BilateralFilterBestOfThree(MobileSAMv2):
    ...
    def __init__(self, d_bilateral=15, sigma_bilateral=75):
        super().__init__(use_bilateral_filter=True, use_bilateral_filter_hyperparams=True,
...
class MobileSAMv2NoFilterBestOfThree(MobileSAMv2):
    ...
    def __init__(self):
        super().__init__(use_bilateral_filter=False, use_bilateral_filter_hyperparams=False, use_best_of_three=True)
...
class MobileSAMv2AutoPointNoFilter(MobileSAMv2AutoPoint):
    ...
    def __init__(self, C=5, d_gaussian=19, n_fgd_points=1000, n_bgd_points=1000, 
                 d_gap_erosion=3):
        super().__init__(use_bilateral_filter=False, use_bilateral_filter_hyperparams=True, use_best_of_three=False,
                         C=C, d_gaussian=d_gaussian, n_fgd_points=n_fgd_points,
                         n_bgd_points=n_bgd_points, d_gap_erosion=d_gap_erosion)
...
class MobileSAMv2AutoPointNoFilterBestOfThree(MobileSAMv2AutoPoint):
    ...
    def __init__(self, C=5, d_gaussian=19, n_fgd_points=1000, n_bgd_points=1000,
                 d_gap_erosion=3):
        super().__init__(use_bilateral_filter=False, use_bilateral_filter_hyperparams=True, use_best_of_three=True,
                         C=C, d_gaussian=d_gaussian, n_fgd_points=n_fgd_points,
                         n_bgd_points=n_bgd_points, d_gap_erosion=d_gap_erosion)
