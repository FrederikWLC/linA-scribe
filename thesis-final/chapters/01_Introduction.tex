...
Then, for \acs{SAM} are: its paper \parencite{sam}, its lighter implementation MobileSAM \parencite{mobile_sam} - and the newest version of that one MobileSAMv2 \parencite{mobile_sam_v2}.
